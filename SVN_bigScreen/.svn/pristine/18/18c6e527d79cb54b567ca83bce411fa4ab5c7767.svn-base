...
public final class IndicatorManager
{
	 ...
	 * @return 地市编号集合
	 */
	public List<String> getCitysNo()
	{
		logger.info("[sc_mobile_fwd]: IndicatorManager.getCitysNo.Citys={}", citys);
		return citys;
	}
	...
	private static void refresh()
	{
		...
		//地市集合
		String city = INDICATOR_PROPERTIES.getProperty("CITYS").trim();
		if (!StringUtils.isEmpty(city))
		{
			citys = Arrays.asList(city.split(DEFAULT_SEPARATOR));
		}
		else
		{
			citys = new ArrayList<String>();
		}
		logger.info("[sc_mobile_fwd]: IndicatorManager.refresh.customer={},market={},auto={},citys={}", 
				customer_perception_indicatros, market_support_indicatros, auto_subscriber_indicatros, citys);
	}
}
